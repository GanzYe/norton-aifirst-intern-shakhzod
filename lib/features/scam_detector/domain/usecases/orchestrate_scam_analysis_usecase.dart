...
/// SOAR pipeline: Incognito → PII scrub →

/// concurrent OSINT → augmented Gemini prompt.
...
class OrchestrateScamAnalysisUseCase {
  ...
  Future<ScamAnalysis> _analyzeOffline({
    ...
    if (!modelReady || !_localScamAnalysisService.isModelReady) {
    ...
    try {
      ...
      throw AnalyzeMessageException(e.message);
