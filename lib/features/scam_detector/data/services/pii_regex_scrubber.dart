...
abstract final class PiiRegexScrubber {
  ...
  static final _nameTypoFragment = RegExp(
  ...
  static const _typoSecondWordStop = {
    'is', 'to', 'at', 'of', 'in', 'on', 'or', 'an', 'as', 'be', 'we', 'he',
    'if', 'so', 'up', 'by', 'my', 'me', 'go', 'do', 'no', 'am', 'it', 'us',
    'the', 'and', 'for', 'are', 'was', 'had', 'has', 'her', 'his', 'not',
  };

  static const _capitalizedAllowlist = {
    'microsoft', 'amazon', 'google', 'apple', 'meta', 'netflix', 'paypal',
    'visa', 'mastercard', 'wells', 'fargo', 'chase', 'citibank', 'bank',
    'irs', 'fbi', 'cia', 'ssa', 'dmv', 'fedex', 'ups', 'usps', 'dhl',
    'hello', 'dear', 'hi', 'hey', 'greetings', 'thanks', 'thank',
    'final', 'notice', 'urgent', 'important', 'attention', 'warning',
    'contact', 'call', 'reach', 'agent', 'officer', 'representative',
    'inspector', 'support', 'team', 'service', 'customer', 'security',
    'account', 'pay', 'gift', 'cards', 'card', 'legal', 'action',
    'warrant', 'arrest', 'taxes', 'today', 'tomorrow', 'immediately',
    'there', 'your', 'our', 'they', 'this', 'that', 'from', 'with',
    'have', 'been', 'will', 'must', 'please', 'company', 'inc', 'llc',
    'corp', 'ltd', 'api', 'key', 'secret', 'token', 'password', 'pin',
    'otp', 'bearer', 'monday', 'tuesday', 'wednesday', 'thursday',
    'friday', 'saturday', 'sunday', 'january', 'february', 'march',
    'april', 'may', 'june', 'july', 'august', 'september', 'october',
    'november', 'december', 'american', 'express', 'western', 'union',
    'bitcoin', 'crypto', 'transfer', 'payment', 'invoice', 'order',
    'delivery', 'package', 'parcel', 'refund', 'prize', 'winner',
    'lottery', 'fed', 'treasury', 'department', 'administration',
    'reply', 'before', 'noon', 'internationalization', 'difficult',
    'calling', 'safe', 'suspicious', 'dangerous',
  };
}
